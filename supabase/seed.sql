...
insert into public.subjects (name, level) values ('Mathematics', 'Baccalaureate') on conflict do nothing;
...
from public.subjects s cross join public.universities u
where s.name = 'Mathematics' and u.name = 'Demo University'
