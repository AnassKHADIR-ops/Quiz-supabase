...
import { Mail, Check, X, Sparkles } from "./Icon.jsx";
...
export default function AdminEmailModal({ isOpen, onClose, recipient, initialTemplateId = "adhesion" }) {
  ...
  // Initialisation ou changement de modèle
  useEffect(() => {
    ...
    >
      <div
        ...
        style={{
          ...
          overflow: "hidden",
          animation: "authModalIn .25s cubic-bezier(0.16, 1, 0.3, 1)",
        }}
      ...
      >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <div>
              ...
              <div style={{ fontSize: "0.78rem", color: "var(--text-muted)", marginTop: 2 }}>
                Via votre compte : <strong style={{ color: "var(--primary)" }}>{PROF_INFO.email}</strong>
              </div>
            </div>
          </div>
          <button
        ...
        <div style={{ padding: "20px 24px", overflowY: "auto", flex: 1, display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          >
            <div>
              <span style={{ color: "var(--text-muted)", marginRight: 6 }}>Destinataire :</span>
              <strong style={{ color: "var(--text)" }}>{recipientName || "Étudiant"}</strong>
              <span style={{ color: "var(--text-muted)", marginLeft: 6 }}>({recipientEmail})</span>
            </div>
            <span
              className="badge"
              style={{
          ...
          {/* Sélecteur de modèle */}
          <div>
            <label style={{ display: "block", fontSize: "0.78rem", fontWeight: 700, color: "var(--text-muted)", marginBottom: 6, textTransform: "uppercase", letterSpacing: "0.05em" }}>
              Modèle de message
            </label>
              ...
              {Object.values(EMAIL_TEMPLATES).map((tpl) => (
                <button
                  ...
                  style={{
                    ...
                    fontWeight: 600,
                    border: "1.5px solid",
                    borderColor: selectedTemplate === tpl.id ? "var(--primary)" : "var(--border)",
                    background: selectedTemplate === tpl.id ? "var(--primary-light, rgba(59, 130, 246, 0.1))" : "var(--surface)",
          ...
          >
            {copied ? (
              <>
                ...
                <span style={{ color: "var(--success)" }}>Copié dans le presse-papier !</span>
              </>
            ) : (
              <>
